        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">Choisissez deux villes pour connaitre la distance qui les sépare</h2>
                    <form method="post" action="CalculerDistanceServlet">
                    	<SELECT class="form-control" name="ville1">
                    		<c:forEach var="ville" items="${ListeVillesFrance}" varStatus="loop">
                    			<OPTION> <c:out value="${ville}"></c:out>
                    		</c:forEach>
                   		</SELECT> <br>
                        ...
                        <button type="submit" class="btn btn-primary mb-2">Calculer la distance</button>
