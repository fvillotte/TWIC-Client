...
/**
 * Servlet implementation class VilleSelectionneServlet
 */
@WebServlet("/VilleSelectionneServlet")
public class VilleSelectionneServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VilleSelectionneServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String villeSelect = request.getParameter("villeSelect");
		...
		Ville ville = null;
		for(Ville villeSelection : listeVilles) {
			if(villeSelection.getNomCommune().equals(villeSelect)) {
				ville = villeSelection;
			}
		}
		
		
		request.setAttribute("VilleSelectionnee", ville);
		
		RequestDispatcher dispat = request.getRequestDispatcher("jsp/VisualiserInfoVille.jsp");
